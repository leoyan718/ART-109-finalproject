...
scene.fog = new THREE.Fog(0xcce0ff, 35, 100);
...
envLoader.load('assets/ghostroom3.gltf', function(gltf) {
    ...
    environment.position.set(0, -4, 0); // Adjust as needed to fit your ghost's height
    environment.scale.set(4, 4, 4); // Scale if too big or small
});
